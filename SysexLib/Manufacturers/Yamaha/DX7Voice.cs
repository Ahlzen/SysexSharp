...
public class DX7Voice : DXVoice, ICanParse
{
    ...
    static DX7Voice()
    {
        ...
        // Index by name
        DX7SingleVoiceParametersByName = DX7SingleVoiceParameters.ToDictionary(parameter => parameter.Name);
    }
    ...
    //internal static DX7Voice FromDictionary(Dictionary<string,object> parameterValues)
    //{
